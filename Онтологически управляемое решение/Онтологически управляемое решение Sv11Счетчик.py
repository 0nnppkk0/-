...
class NutrientAnalyzer:
    ...
    def calculate(self, answers: List[Dict]) -> Tuple[pd.DataFrame, bool, List[str]]:
        ...
        for answer in answers:
            ...
            print("ПОРЦИЯ:", portion)
            product_data = self.repository.get_product_data(product_name)
            print("PRODUCT DATA:")
            print(product_data)

            print("PRODUCT DATA FOUND:", product_data is not None)
            if not product_data:
                continue
...
class SurveyApp:
    ...
    def setup_selection_ui(self):
        ...
        for product_id, category_id in self.all_products:
            ...
            if category_name != current_category:
                ...
                self.options_lb.insert(tk.END, f"=== {category_name} ===")
        ...
        for widget in self.survey_frame.pack_slaves():
    ...
    def start_selected_survey(self):
        ...
        self.products = self.selected_products
