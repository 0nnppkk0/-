...
XLSX_PATH = Path(r"C:\Users\welta\OneDrive\Desktop\Универ\Курсовая\Перенос данных в  онтологию\Вырезка по продуктам.xlsx")
...
OUTPUT_XLSX_PATH = Path(r"C:\Users\welta\OneDrive\Desktop\Универ\Курсовая\Перенос данных в  онтологию\УЛ Вырезка по продуктам.xlsx")
